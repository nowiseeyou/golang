// codeWalk : Go 中一等函数 http://docscn.studygolang.com/doc/codewalk/functions/
...
// stay 返回停留时产生的结果 （result,turnIsOver） outcome of staying
// 这一轮 thisTurn 的分数会计入该玩家的总分中，然后玩家角色互换
